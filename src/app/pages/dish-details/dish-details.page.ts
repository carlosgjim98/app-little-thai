...
export class DishDetailsPage implements OnInit {
  ...
  loadDishDetails(id: number) {
    const dishes = [
      { id: 1, name: 'Gambas bites', category: 'Entrantes', img: 'assets/imgs/bolitas-de-gamba-scaled (1)@3x.png', description: 'Bolas crujientes de gamba acompañadas de una salsa a elegir.', price: 6.95},
      { id: 2, name: 'Thai bites', category: 'Entrantes', img: 'assets/imgs/Fotos-Glovo-y-web-nueva-6-600x600@3x.png', description: 'Bocados crujientes de ternera especiada acompañados de 2…', price: 5.95 },
      { id: 3, name: 'Tempura de gambas', category: 'Entrantes', img: 'assets/imgs/9.TEMPURAGAMBAS@3x.png', description: 'La tempura de gamba, un clásico que nunca falla…', price: 5.95 },
